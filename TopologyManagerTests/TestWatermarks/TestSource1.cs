...
namespace OSPTests.TestWatermarks
{
    ...
    public class TestSource1 : Source<TestObject>
    {
        ...
        public async override Task Start()
        {
            ...
            Thread.Sleep(1500);
            TestObject dtt2 = new TestObject() { SomeData = "b", TimeStamp = new DateTime(2019, 10, 10, 10, 10, 11, 100) };
            Data<TestObject> dt2 = new Data<TestObject>(GetKey(dtt2), dtt2);
            SendMessageToStream(dt2);
            Thread.Sleep(1500);
            TestObject dtt3 = new TestObject() { SomeData = "c", TimeStamp = new DateTime(2019, 10, 10, 10, 10, 12, 500) };
